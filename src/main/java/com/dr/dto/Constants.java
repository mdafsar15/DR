...
public class Constants {
	...
	/*
	 * Increase Date range from 3 month to 6 months Author:Deepak Date: 17-05-22
	 */
	...
	public static final String REGISTER_BLOCKCHAIN_REPLICATION_URL = "http://localhost:8081/micro/birthRegister";
	public static final String REGISTER_BLOCKCHAIN_DR_URL = "http://localhost:8080/crud/birth";
	...
	public static final String GOVT_CHANNEL = "ndmcgovtchannel";
	public static final String PVT_CHANNEL = "ndmcpivtchannel";
	public static final String HOME_CHANNEL = "ndmcgovtchannel";
	public static final String SDM_CHANNEL = "ndmcsdmchannel";
	...
	public static String NDMC_PIVT_USER = "ndmcPivtUser";
	public static String NDMC_SDM_USER = "ndmcSdmUser";
	...
	// public static String NAME_ALREADY_INCLUDED_MESSAGE="Record not found or Name
	// is already included.";
	...
	public static final String REGISTER_BIRTH_BLC_FUNC = "createBirthCertificate";
	public static final String REGISTER_DEATH_BLC_FUNC = "createDeathCertificate";
	public static final String REGISTER_SBIRTH_BLC_FUNC = "createStillBirthCertificate";
	public static final String UPDATE_BIRTH_BLC_FUNC = "birthCertificateModify";
	public static final String UPDATE_DEATH_BLC_FUNC = "deathCertificateModify";
	public static final String UPDATE_SBIRTH_BLC_FUNC = "stillBirthCertificateModify";
	public static final String BLC_CLIENT_USER = "ndmcdruser";
	public static final String BLC_CONNECTION_PROFILE = "ndmc-connection.json";
	public static final String BLC_CONTRACT_METHOD = "createBirthCertificate";
	public static final String BLC_CHANNEL = "ndmcgovtchannel";
	public static final String BLC_SMART_CONTRACT = "ndmctest";
	public static final String BLC_BLOCKCHAIN = "HyperledgerFabric";
	public static final String BLC_WALLET_PATH = "ndmc";
	public static final String RECORD_ERROR = "ERROR";
	public static final String BLC_HYPERLEDGERFABRIC = "HyperledgerFabric";
